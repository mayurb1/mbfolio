...
// Build a preloaded `master` slice from server-fetched master data (SSR hydration)
export const buildMasterState = (data) => {
  if (!data) return undefined
  return {
    ...initialState,
    user: data.user ?? initialState.user,
    stats: data.stats ?? initialState.stats,
    highlights: data.highlights ?? initialState.highlights,
