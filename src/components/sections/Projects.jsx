  ...
  const projects = [
    {
      ...
      description: 'A comprehensive e-commerce solution with real-time inventory management, payment processing, and admin dashboard.',
      category: 'Full-Stack',
    ...
    },
    {
      ...
      technologies: ['React', 'TypeScript', 'Socket.io', 'Firebase', 'Material-UI'],
      ...
      fullDescription: 'A modern task management application that enables teams to collaborate effectively. Features include real-time updates, drag-and-drop interfaces, file attachments, commenting system, and comprehensive analytics dashboard. Built with React and TypeScript for type safety and maintainability.',
      screenshots: [
    ...
    },
    {
      ...
      technologies: ['Vue.js', 'Vuex', 'Chart.js', 'OpenWeather API', 'Leaflet'],
      ...
      fullDescription: 'A comprehensive weather dashboard that provides detailed weather information with beautiful visualizations. The app integrates with multiple weather APIs to provide accurate forecasts and features interactive maps, charts, and a clean, intuitive interface.',
      screenshots: [
    ...
    },
    {
      ...
      description: 'A robust API gateway service with authentication, rate limiting, and comprehensive monitoring capabilities.',
      category: 'Backend',
      ...
      fullDescription: 'A production-ready API gateway that handles authentication, authorization, rate limiting, and monitoring for microservices. Built with scalability and security in mind, featuring comprehensive logging and analytics.',
      screenshots: [
        '/projects/api-1.jpg'
      ],
      metrics: {
    ...
    },
    {
      ...
      description: 'A collection of machine learning projects including image classification, NLP, and predictive analytics.',
      category: 'Data Science',
      image: '/projects/ml-portfolio.jpg',
      technologies: ['Python', 'TensorFlow', 'Pandas', 'Scikit-learn', 'Jupyter', 'Flask'],
      ...
      fullDescription: 'A comprehensive collection of machine learning projects showcasing various techniques and applications. Includes computer vision, natural language processing, and predictive modeling projects with detailed documentation and live demos.',
      screenshots: [
        '/projects/ml-1.jpg',
        '/projects/ml-2.jpg',
        '/projects/ml-3.jpg'
    ...
    },
    {
      ...
      description: 'Scalable backend infrastructure for a social media mobile application with real-time messaging.',
      category: 'Backend',
      image: '/projects/mobile-backend.jpg',
      technologies: ['Node.js', 'GraphQL', 'PostgreSQL', 'Redis', 'AWS', 'Socket.io'],
      ...
      fullDescription: 'A robust backend system designed to support a social media mobile application. Features include user management, real-time messaging, content delivery, and analytics. Built with GraphQL for efficient data fetching and real-time subscriptions.',
      screenshots: [
        ...
        >
          ...
          >
            ...
            <div className="p-6">
              ...
              {/* Description */}
              <div className="mb-6">
                <h3 className="text-lg font-semibold text-text mb-3">About This Project</h3>
              ...
              {/* Highlights */}
              <div className="mb-6">
                <h3 className="text-lg font-semibold text-text mb-3">Key Highlights</h3>
              ...
              {/* Technologies */}
              <div className="mb-6">
                <h3 className="text-lg font-semibold text-text mb-3">Technologies Used</h3>
              ...
              {project.metrics && (
                <div className="mb-6">
                  <h3 className="text-lg font-semibold text-text mb-3">Project Metrics</h3>
